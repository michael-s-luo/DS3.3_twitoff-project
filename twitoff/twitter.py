""" 
Functions to query Twitter v1.1 API for user & tweet information, 
...
def add_or_update_user(username):
    ...
    (excluding retweets) to local database instance. If user is already present in
    ...
    try:
        ...
        # TODO: remove urls/links and special characters for better predictions
        for tweet in tweets:
